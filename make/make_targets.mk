...
debug_obj: debug_dir $(DEBUG_OBJECTS)
	...
	$(VERBOSE) $(CC) $(CFLAGS) $(OPTIMIZATION) $(DEFS) $(LDFLAGS) $(MCU_FLAG) $(INC_PATH:%=-I%) $(DEBUG_ENABLED) $(LOCAL_DEBUG_OBJECTS:%=$(DEBUG_DIRECTORY)/%) -o $(OBJECT_DIRECTORY)/$(TARGET).$(PLATTFORM_EXTENSION) $(LFLAGS) $(LIBS)
