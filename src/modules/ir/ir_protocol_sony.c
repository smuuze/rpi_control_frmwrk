 ...
 */
static void ir_protocol_sony_prepare_transmit_buffer(const IR_COMMON_COMMAND_TYPE* p_command) {
 ...
 */
static void ir_protocol_sony_transmit_prepare(const IR_COMMON_COMMAND_TYPE* p_command) {
...
void ir_protocol_sony_transmit_irq(void) {
    ...
    DEBUG_PASS("ir_protocol_sony_transmit_irq()");
