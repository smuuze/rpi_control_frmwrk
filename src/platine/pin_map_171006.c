...
BUILD_GPIO(EXTERN_INPUT_01,	GPIO_PORT_A, 	GPIO_PIN_0, 	GPIO_INVERTED | GPIO_IDLE_HIGH_Z	)
BUILD_GPIO(EXTERN_INPUT_02,	GPIO_PORT_A, 	GPIO_PIN_1, 	GPIO_INVERTED | GPIO_IDLE_HIGH_Z	)
BUILD_GPIO(EXTERN_INPUT_03,	GPIO_PORT_A, 	GPIO_PIN_2, 	GPIO_INVERTED | GPIO_IDLE_HIGH_Z	)
BUILD_GPIO(EXTERN_INPUT_04,	GPIO_PORT_A, 	GPIO_PIN_3, 	GPIO_INVERTED | GPIO_IDLE_HIGH_Z	)
BUILD_GPIO(ONBOARD_INPUT_01,	GPIO_PORT_A, 	GPIO_PIN_4, 	GPIO_INVERTED | GPIO_IDLE_HIGH_Z	)
BUILD_GPIO(ONBOARD_INPUT_02,	GPIO_PORT_A, 	GPIO_PIN_5, 	GPIO_INVERTED | GPIO_IDLE_HIGH_Z	)
...
BUILD_GPIO(HOST_SPI_CE,		GPIO_PORT_B, 	GPIO_PIN_4, 	GPIO_IDLE_HIGH_Z		)
BUILD_GPIO(HOST_SPI_MOSI, 	GPIO_PORT_B, 	GPIO_PIN_5, 	GPIO_IDLE_HIGH_Z		)
BUILD_GPIO(HOST_SPI_MISO, 	GPIO_PORT_B, 	GPIO_PIN_6, 	GPIO_IDLE_HIGH_Z		)
BUILD_GPIO(HOST_SPI_SCK, 	GPIO_PORT_B, 	GPIO_PIN_7, 	GPIO_IDLE_HIGH_Z		)

//----------------------------------------------------------------------------------------------------------------------------------
//   Port C (0x08)
//---------  Name , Port, Bit,	  Idle-State
BUILD_GPIO(MCU_PIN_19, 		GPIO_PORT_C, 	GPIO_PIN_0, 	GPIO_IDLE_HIGH_Z		)
BUILD_GPIO(MCU_PIN_20, 		GPIO_PORT_C, 	GPIO_PIN_1, 	GPIO_IDLE_HIGH_Z		)
