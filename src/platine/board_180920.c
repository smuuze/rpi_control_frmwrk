...
BUILD_GPIO(EXT_POWER_01,	GPIO_PORT_A, 	GPIO_PIN_5, 	GPIO_OUTPUT | GPIO_IDLE_HIGH		)	// has extern Pull-Up resistor
...
BUILD_GPIO(UART1_RX, 		GPIO_PORT_D, 	GPIO_PIN_2, 	GPIO_INPUT | GPIO_IDLE_HIGH		)
BUILD_GPIO(UART1_TX, 		GPIO_PORT_D, 	GPIO_PIN_3, 	GPIO_INPUT | GPIO_IDLE_HIGH		)
