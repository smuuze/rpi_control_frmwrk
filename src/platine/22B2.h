//--------------------------------------------------------------------------------------------------------------
//       Hardwarebeschreibung   :  RPi Eval Board V2 - ATMega1284P @ 3 Volt / 14,7456 MHz
//--------------------------------------------------------------------------------------------------------------
//
...
//---------  Name		, Port	, Bit	, STARTUP			, SLEEPMODE
 ...
 DEF_GPIO_2( MSPI_CS	        , A	, 6	, OUTPUT_OFF | INVERTED		, OUTPUT_OFF | INVERTED		) //
 DEF_GPIO_2( UNUSED_PA7	        , A	, 7	, INPUT_HIGH_Z			, INPUT_HIGH_Z			) //
...
//---------  Name		, Port	, Bit	, STARTUP			, SLEEPMODE
 ...
 DEF_GPIO_2( SPI0_CE	        , B	, 4	, INPUT_PULLUP			, INPUT_PULLUP			) //
...
//---------  Name        	Port	, Bit	, STARTUP			, SLEEPMODE
 ...
 DEF_GPIO_2( UNUSED_PC4	        , C	, 4	, INPUT_HIGH_Z			, INPUT_HIGH_Z			) //
 DEF_GPIO_2( UNUSED_PC5	        , C	, 5	, INPUT_HIGH_Z			, INPUT_HIGH_Z			) //
...
//---------  Name        	Port	, Bit	, STARTUP			, SLEEPMODE
 ...
 DEF_GPIO_2( MSPI_MOSI      	, D	, 2	, OUTPUT_ON			, OUTPUT_ON			) //
 DEF_GPIO_2( MSPI_MISO     	, D	, 3	, INPUT_PULLUP			, INPUT_PULLUP			) //
 DEF_GPIO_2( MSPI_SCK      	, D	, 4	, OUTPUT_OFF			, OUTPUT_OFF			) //
 DEF_GPIO_2( UNUSED_PD6	        , D	, 5	, INPUT_HIGH_Z			, INPUT_HIGH_Z			) //
 DEF_GPIO_2( TRACES_OUT	        , D	, 6	, OUTPUT_OFF			, OUTPUT_OFF			) //
...
//   GPIO - Aliases
 ...
 GPIO_ALIAS( UART0_SEND485      , D,4 , OUTPUT_OFF | INVERTED	)
