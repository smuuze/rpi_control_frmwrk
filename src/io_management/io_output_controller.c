 ...
 * 
 */
static void io_output_controller_task_start(void) {
 ...
 * @return u16 
 */
static u16 io_output_controller_task_get_schedule_interval(void) {
    return 5;
}
 ...
 */
static MCU_TASK_INTERFACE_TASK_STATE io_output_controller_task_get_state(void) {
 ...
 * 
 */
static void io_output_controller_task_execute(void) {
 ...
 * 
 */
static void io_output_controller_task_terminate(void) {
...
TASK_CREATE(
    ...
    io_output_controller_task_get_schedule_interval,
    io_output_controller_task_start,
    io_output_controller_task_execute,
    io_output_controller_task_get_state,
    io_output_controller_task_terminate
)
