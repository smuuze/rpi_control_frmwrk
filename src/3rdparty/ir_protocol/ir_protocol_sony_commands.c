...
inline void ir_protocol_sony_address_bdplayer(SONY_IR_PROTOCOL_COMMAND_TYPE* p_command) {
	p_command->device   = 0b00001011;
	p_command->extended = 0b01000111;
}
