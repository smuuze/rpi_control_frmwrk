 ...
 * @date   2022 / 03 / 21
 * @brief  Implementation of the Sony IR-Data transmission protocol
 * 
 */
...
#define SONY_IR_PROTOCOL_TRANSMIT_BUFFER_BIT_COUNT              0
...
#define SONY_IR_PROTOCOL_MOD_TIME_STOP_BIT_START_MS             27
