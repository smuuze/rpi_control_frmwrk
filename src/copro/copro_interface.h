...
#ifndef _H_copro_interface_
#define _H_copro_interface_
...
/*
 */
typedef u8 (*COPRO_INTERFACE_POWER_IS_ON_CALLBACK) (void);
...
typedef struct {
    ...
    COPRO_INTERFACE_POWER_IS_ON_CALLBACK        power_is_on;
...
#define COPRO_INTERFACE_CRATE(name, power_on_callback, power_is_on_callback, power_off_callback)                \
                                                                \
