...
SIGNAL_SLOT_INTERFACE_CREATE_SLOT(
    ...
    MQTT_NEW_CFG_OBJECT_SLOT,
    mqtt_new_cfg_object_CALLBACK
)

SIGNAL_SLOT_INTERFACE_CREATE_SLOT(
    CFG_PARSER_CFG_COMPLETE_SIGNAL,
    MQTT_CFG_COMPLETE_SLOT,
    mqtt_cfg_complete_CALLBACK
)

SIGNAL_SLOT_INTERFACE_CREATE_SLOT(
    MQTT_MESSAGE_TO_SEND_SIGNAL,
    MQTT_MESSAGE_TO_SEND_SLOT,
    mqtt_message_to_send_CALLBACK
)

// --------------------------------------------------------------------------------

MQTT_INTERFACE_BUILD_CLIENT(
    MQTT_CLIENT,
    MQTT_APPLICATION_MAX_MSG_LENGTH,
    MQTT_APPLICATION_TX_QEUE_SIZE,
    MQTT_APPLICATION_RX_QEUE_SIZE
)
...
void mqtt_interface_init(void) {
    ...
    DEBUG_PASS("mqtt_interface_init() - MQTT_NEW_CFG_OBJECT_SLOT_connect()");
    MQTT_NEW_CFG_OBJECT_SLOT_connect();

    DEBUG_PASS("mqtt_interface_init() - MQTT_CFG_COMPLETE_SLOT_connect()");
...
static void mqtt_new_cfg_object_CALLBACK(const void* p_argument) {
    ...
    if (common_tools_string_compare(MQTT_HOST_CFG_STRING, p_cfg_object->key)) {
        ...
        DEBUG_TRACE_STR(p_cfg_object->value, "mqtt_new_cfg_object_CALLBACK() - MQTT_HOST cfg-object");
    ...
    if (common_tools_string_compare(MQTT_TOPIC_CFG_STRING, p_cfg_object->key)) {
        ...
        DEBUG_TRACE_STR(p_cfg_object->value, "mqtt_new_cfg_object_CALLBACK() - MQTT_TOPIC cfg-object");
    ...
    if (common_tools_string_compare(MQTT_CLIENT_ID_CFG_STRING, p_cfg_object->key)) {
        ...
        DEBUG_TRACE_STR(p_cfg_object->value, "mqtt_new_cfg_object_CALLBACK() - MQTT_CLIENT_ID cfg-object");
    ...
    if (common_tools_string_compare(MQTT_KEEP_ALIVE_INTERVAL_CFG_STRING, p_cfg_object->key)) {
        ...
        DEBUG_TRACE_STR(p_cfg_object->value, "mqtt_new_cfg_object_CALLBACK() - MQTT_KEEP_ALIVE_INTERVAL cfg-object");
    ...
    if (common_tools_string_compare(MQTT_TIMEOUT_CFG_STRING, p_cfg_object->key)) {
        ...
        DEBUG_TRACE_STR(p_cfg_object->value, "mqtt_new_cfg_object_CALLBACK() - MQTT_TIMEOUT cfg-object");
    ...
    if (common_tools_string_compare(MQTT_WELCOME_MSG_CFG_STRING, p_cfg_object->key)) {
        ...
        DEBUG_TRACE_STR(p_cfg_object->value, "mqtt_new_cfg_object_CALLBACK() - MQTT_WELCOME_MSG cfg-object");
