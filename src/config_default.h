...
#define config_SYSTEM_INTERFACE_IO_INIT_PIN_PROTOTYPE		void gpio_driver_init_pin(GPIO_DRIVER_PIN_DESCRIPTOR* p_pin_descr);
#define config_SYSTEM_INTERFACE_IO_SET_PIN_DIR_PROTOTYPE 	void gpio_driver_set_direction(GPIO_DRIVER_PIN_DESCRIPTOR* p_pin_descr, GPIO_DRIVER_DIRECTION direction);
#define config_SYSTEM_INTERFACE_IO_SET_PIN_LEVEL_PROTOTYPE 	void gpio_driver_set_level(GPIO_DRIVER_PIN_DESCRIPTOR* p_pin_descr, GPIO_DRIVER_LEVEL level);
#define config_SYSTEM_INTERFACE_IO_TOGGLE_PIN_LEVEL_PROTOTYPE	void gpio_driver_toggle_level(GPIO_DRIVER_PIN_DESCRIPTOR* p_pin_descr);
#define config_SYSTEM_INTERFACE_IO_GET_PIN_LEVEL_PROTOTYPE 	GPIO_DRIVER_LEVEL gpio_driver_get_level(GPIO_DRIVER_PIN_DESCRIPTOR* p_pin_descr);
