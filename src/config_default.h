...
#define config_SYSTEM_INTERFACE_GET_TIME_U8_PROTOTYPE		ux8 msticker_get_time_ux8(void);
#define config_SYSTEM_INTERFACE_GET_TIME_U16_PROTOTYPE		ux16 msticker_get_time_ux16(void);
#define config_SYSTEM_INTERFACE_GET_TIME_U32_PROTOTYPE		ux32 msticker_get_time_ux32(void);

#define config_SYSTEM_INTERFACE_GET_TIME_U8_CALLBACK		msticker_get_time_ux8
#define config_SYSTEM_INTERFACE_GET_TIME_U16_CALLBACK		msticker_get_time_ux16
#define config_SYSTEM_INTERFACE_GET_TIME_U32_CALLBACK		msticker_get_time_ux32

#define config_SYSTEM_INTERFACE_IS_TIME_UP_U8_PROTOTYPE		ux8 mstimer_time_is_up_ux8(const ux8 reference_time, const ux8 time_interval);
#define config_SYSTEM_INTERFACE_IS_TIME_UP_U16_PROTOTYPE	ux8 mstimer_time_is_up_ux16(const ux16 reference_time, const ux16 time_interval);
#define config_SYSTEM_INTERFACE_IS_TIME_UP_U32_PROTOTYPE	ux8 mstimer_time_is_up_ux32(const ux32 reference_time, const ux32 time_interval);

#define config_SYSTEM_INTERFACE_IS_TIME_UP_U8_CALLBACK		mstimer_time_is_up_ux8
#define config_SYSTEM_INTERFACE_IS_TIME_UP_U16_CALLBACK		mstimer_time_is_up_ux16
#define config_SYSTEM_INTERFACE_IS_TIME_UP_U32_CALLBACK		mstimer_time_is_up_ux32
