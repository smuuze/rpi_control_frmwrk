...
void keypad_driver_init(void) {
    ...
    KEY_COL_1_activate();    KEY_COL_1_drive_low();
    KEY_COL_2_activate();    KEY_COL_2_drive_low();
    KEY_COL_3_activate();    KEY_COL_3_drive_low();
    
    KEY_ROW_1_activate();    KEY_ROW_1_pull_down();
    KEY_ROW_2_activate();    KEY_ROW_2_pull_down();
    KEY_ROW_3_activate();    KEY_ROW_3_pull_down();
    KEY_ROW_4_activate();    KEY_ROW_4_pull_down();
}
...
u8 keypad_driver_is_key_pressed(void) {
    ...
    u8 key_pressed  =  KEY_ROW_1_is_high_level()
    ...
    key_pressed  =  KEY_ROW_1_is_high_level()
                 || KEY_ROW_2_is_high_level()
                 || KEY_ROW_3_is_high_level()
                 || KEY_ROW_4_is_high_level();
    KEY_COL_2_drive_low();
